...
-- 4.1 Compras de Valentina Anastasia Huerta Corral (id_cliente = 2)
...
-- 4.2 Compras de Zayra Manuela Gómez López (id_cliente = 17)
SELECT c.nombre, c.apellido, f.id_factura, f.fecha, p.nombre AS Producto, d.cantidad, d.precio
FROM cliente c
INNER JOIN factura f  ON c.id_cliente = f.id_cliente
INNER JOIN detalle d  ON f.id_detalle = d.id_detalle
...
-- 4.3 Compras de Dante Eduardo Dolores Meza (id_cliente = 24)
SELECT c.nombre, c.apellido, f.id_factura, f.fecha, p.nombre AS Producto, d.cantidad, d.precio
FROM cliente c
INNER JOIN factura f  ON c.id_cliente = f.id_cliente
INNER JOIN detalle d  ON f.id_detalle = d.id_detalle
...
-- 4.4 Compras de Ana Maribel Cedillo Núñez (id_cliente = 4)
SELECT c.nombre, c.apellido, f.id_factura, f.fecha, p.nombre AS Producto, d.cantidad, d.precio
FROM cliente c
INNER JOIN factura f  ON c.id_cliente = f.id_cliente
INNER JOIN detalle d  ON f.id_detalle = d.id_detalle
...
-- 4.5 Compras de Rodrigo Ismael Silva Ugarte (id_cliente = 11)
SELECT c.nombre, c.apellido, f.id_factura, f.fecha, p.nombre AS Producto, d.cantidad, d.precio
FROM cliente c
INNER JOIN factura f  ON c.id_cliente = f.id_cliente
INNER JOIN detalle d  ON f.id_detalle = d.id_detalle
...
-- 7. Compras ordenadas de la más antigua a la más reciente
...
-- 9.1 Productos de la categoría Falda
...
-- 9.2 Productos de la categoría Pantalón
SELECT p.id_producto, p.nombre, p.precio, p.stock
FROM producto p
INNER JOIN categoria cat ON p.id_categoria = cat.id_categoria
...
-- 9.3 Productos de la categoría Chamarra
SELECT p.id_producto, p.nombre, p.precio, p.stock
FROM producto p
INNER JOIN categoria cat ON p.id_categoria = cat.id_categoria
...
-- 9.4 Productos de la categoría Zapatos
SELECT p.id_producto, p.nombre, p.precio, p.stock
FROM producto p
INNER JOIN categoria cat ON p.id_categoria = cat.id_categoria
...
-- 9.5 Productos de la categoría Accesorios
SELECT p.id_producto, p.nombre, p.precio, p.stock
FROM producto p
INNER JOIN categoria cat ON p.id_categoria = cat.id_categoria
